...
public enum ProfileImageFileType {
    ...
    public static ProfileImageFileType from(String fileName, String contentType) {
        ...
        return Arrays.stream(values())
                ...
                .findFirst()
                .orElseThrow(() -> new UploadException(ErrorCode.UNSUPPORTED_IMAGE_TYPE));
    }

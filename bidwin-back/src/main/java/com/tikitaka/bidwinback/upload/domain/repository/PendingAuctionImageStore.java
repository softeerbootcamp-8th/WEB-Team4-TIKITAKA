package com.tikitaka.bidwinback.upload.domain.repository;
...
public interface PendingAuctionImageStore {
    ...
    // 경매 등록 시 요청에 실린 uploadId가 실제로 이 회원의 이 draftId(등록 시도) 소속인지 확인하는 용도.
    // draftId까지 확인해야, 다른 세션(예: 이전에 등록을 포기한 draft)에 남아있던 uploadId가
